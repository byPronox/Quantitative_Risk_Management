...
class Settings:
    ...
    MODELS_BASE_PATH: str = os.getenv("MODELS_BASE_PATH", "/app/src/models")
    ...
    def __init__(self):
        ...
        if not self.CICIDS_MODEL_PATH:
            ...
            local_path = str(Path(__file__).parent.parent / "models" / "rf_cicids2017_model.pkl")
        ...
        if not self.LANL_MODEL_PATH:
            ...
            local_path = str(Path(__file__).parent.parent / "models" / "isolation_forest_model.pkl")
