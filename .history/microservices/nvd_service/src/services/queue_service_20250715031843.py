            ...
            try:
                with httpx.Client(timeout=30.0) as client:
                    ...
                    if response.status_code == 200:
                        ...
                        logger.info(f"Retrieved {len(all_jobs_from_endpoint)} jobs from /nvd/results/all endpoint")
                    else:
            ...
            if jobs_to_save:
                ...
                def bulk_save_to_mongodb():
                    try:
                        ...
                        loop.close()
                        logger.info(f"Bulk saved {len(jobs_to_save)} jobs from /nvd/results/all to MongoDB")
                ...
                logger.info("No new jobs found from /nvd/results/all to save to MongoDB (all jobs already exist)")
