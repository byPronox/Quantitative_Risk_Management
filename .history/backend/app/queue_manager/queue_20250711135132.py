...
class RabbitMQManager:
    ...
    async def get_queue_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                # Simple queue inspection - just return basic info
                return {
                    "connected": True,
                    "queue_name": self.queue_name,
                    "queue_size": 0,  # Would need to implement proper queue inspection
                    "total_vulnerabilities": 0,
                    "keywords": [],
                    "pending": 0,
                    "processing": 0,
                ...
                logger.warning(f"Could not inspect queue: {queue_error}")
                return {
                    "connected": True,
                    "queue_name": self.queue_name,
                    "queue_size": 0,
                    "total_vulnerabilities": 0,
                    "keywords": [],
                    "error": f"Queue inspection failed: {str(queue_error)}"
                }
