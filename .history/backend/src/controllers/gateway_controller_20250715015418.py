...
@router.get("/nvd/mongodb/reports/keywords")
...
@router.get("/nvd/mongodb/reports/detailed/{keyword}")
...
@router.post("/nvd/mongodb/analyze")
async def proxy_nvd_mongodb_analyze(request: Request):
