...
// Funciones para controlar el consumidor RabbitMQ
export async function startConsumer() {
  try {
    const response = await api.post("/nvd/queue/consumer/start");
    return response.data;
  } catch (error) {
...
export async function stopConsumer() {
  try {
    const response = await api.post("/nvd/queue/consumer/stop");
    return response.data;
  } catch (error) {
...
export async function getConsumerStatus() {
  try {
    const response = await api.get("/nvd/queue/consumer/status");
    return response.data;
  } catch (error) {
