                ...
                >
                  <div style={{
                    ...
                    <h3 style={{
                      ...
                      📦 {job.software_name || `Job ${job.job_id}`}
                    </h3>
                  ...
                  {job.timestamp && (
                    <p style={{
                      ...
                      🕒 Processed: {new Date(job.timestamp).toLocaleString()}
                    </p>
                  )}
                  ...
                  {job.vulnerabilities && job.vulnerabilities.length > 0 ? (
                    <div>
                      <h4 style={{
                        ...
                        🚨 Vulnerabilities Found ({job.vulnerabilities.length})
                      </h4>
                      <div style={{
                        display: "grid",
                          ...
                          <div
                            ...
                            style={{
                              ...
                              borderLeft: `4px solid ${
                                vuln.severity === "HIGH" ? "#dc2626" :
                                vuln.severity === "MEDIUM" ? "#f59e0b" :
                                vuln.severity === "LOW" ? "#10b981" : "#6b7280"
                              }`
                            }}
                          >
                            <div style={{
                              ...
                              {vuln.severity && (
                                <span style={{
                                  background: 
                                    vuln.severity === "HIGH" ? "#fee2e2" :
                                    vuln.severity === "MEDIUM" ? "#fef3c7" :
                                    vuln.severity === "LOW" ? "#dcfce7" : "#f3f4f6",
                                  color:
                                    vuln.severity === "HIGH" ? "#dc2626" :
                                    vuln.severity === "MEDIUM" ? "#f59e0b" :
                                    vuln.severity === "LOW" ? "#10b981" : "#6b7280",
                            ...
                            <div style={{
                              ...
                              {vuln.base_score && (
                                <div>
                                  ...
                                  <span style={{
                                    color: vuln.base_score >= 7 ? "#dc2626" : 
                                           vuln.base_score >= 4 ? "#f59e0b" : "#10b981",
                                    fontWeight: "600"
                                  }}>
                                    {vuln.base_score}/10
                                  </span>
